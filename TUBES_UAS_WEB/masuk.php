                                    ...
                                    <form method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            ?>
                                                ...
                                                <option value="<?=$idProduk;?>"><?=$namaProduk;?> -
                                                    <?=$deskripsiProduk;?> (Stock : <?=$stokProduk?>)</option>

                                                <?php
                                            };
                                            ?>
                                            </select>
                                            <input type="number" name="qty_masuk" class="form-control mt-4"
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-success"
                                                name="add_produk_masuk">Submit</button>
                                        </div>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="deskripsi_produk"
                                                                ...
                                                                value="<?=$deskripsiProduk;?>" disabled><br>
                                                            <input type="number" name="qty" class="from-control mt-2"
                                                                placeholder="Jumlah Produk" value="<?=$jumlah?>"><br>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success"
                                                                name="edit_barang_masuk">Submit</button>
                                                        </div>
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <!-- Modal body -->
                                                        <div class="modal-body">
                                                            apakah_anda_yakin_ingin_menghapus_data_barang_masuk_tersebut_?
                                                            <input type="hidden" name="idp" value="<?=$idProduk;?>">
                                                            <input type="hidden" name="idm" value="<?=$idMasuk;?>">
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success"
                                                                name="hapus_barang_masuk">Submit</button>
                                                        </div>

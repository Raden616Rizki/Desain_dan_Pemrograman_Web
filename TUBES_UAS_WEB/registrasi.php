...
<body class="bg-secondary">
    <div id="layoutAuthentication">
        <div id="layoutAuthentication_content">
            <main>
                <div class="container">
                    <h1 class="text-center text-white font-weight-light">Silahkan Registrasi di B-Order</h1>
                    <div class="d-flex">
                        <img class="p-2" src="./image/registrasi_ilustrasi.png" alt="registration_ilustration"
                            style="width: 640px; margin-top:32px;">
                        <div class="p-2 col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header bg-info">
                                    <h3 class="text-center text-white font-weight-light my-4">Registrasi</h3>
                                </div>
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="d-flex align-items-center justify-content-around mt-4 mb-0">
                                            <button type="submit" name="registrasi" class="btn btn-info"
                                                href="login.php">Registrasi</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
